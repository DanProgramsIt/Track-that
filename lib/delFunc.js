        ...
        const confirm = await promptUser([
            {
                ...
                type: "confirm",
                default: false,
                message: `\nAre you sure you want to remove ${empToRemove[0].first_name} ${empToRemove[0].last_name}? They Will Be Gone Forever!!!`
            }
        ]);
        if (confirm.yN) {
        ...
        const confirm = await promptUser([
            {
                ...
                type: "confirm",
                default: false,
                message: `\nAre you sure you want to delete ${removeDept[0].department}? They Will Be Gone Forever!!!`
            }
        ]);
        if (confirm.yN) {
